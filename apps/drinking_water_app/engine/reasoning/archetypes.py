...
def run_archetype_selection(inputs: SourceWaterInputs,
    ...
    # Priority: mandatory archetypes first, then most appropriate
    if result.requires_membrane and inputs.treatment_objective == "recycled":
        ...
        result.recommendation_rationale = (
            "Softening-led treatment is required where hardness reduction is the primary objective."
        )
        ...
        result.recommendation_rationale = (
            ...
            "dissolved contaminant challenge."
        )
        ...
        result.recommendation_rationale = (
            ...
            "MIB/geosmin taste and odour control."
        )
        ...
        result.recommendation_rationale = (
            ...
            "This is the simplest and most robust option for this source."
        )
    else:
