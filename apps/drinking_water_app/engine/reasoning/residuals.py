...
RESIDUAL_STREAMS = {
    ...
    "lime_sludge": {
        ...
        "solids_content": "5–15% TS as generated; gelatinous at high Mg content",
        "dewaterability": "Poor to very poor — CaCO₃ sludge centrifuges to ~40% DS but is "
                          "voluminous; Mg(OH)₂ fraction is gelatinous and very difficult to dewater",
        "generation": "Continuous",
        "disposal_options": ["lagoon storage (most common)", "land application as agricultural lime (if suitable chemistry)", "landfill"],
        "special_considerations": [
            "⚠ Lime sludge is the single largest residuals challenge for softening plants — "
            "volume typically 10–30× greater than equivalent conventional sludge",
            "Magnesium hydroxide sludge fraction is gelatinous and resists mechanical dewatering",
            "High pH (10–12) — corrosive handling; chemical burns risk",
            "Lagoon storage requires significant land area — often a site-controlling constraint",
            "High sodium content if Na₂CO₃ used for non-carbonate hardness — limits agricultural reuse",
        ],
        "biopoint_relevant": True,
    },
    "filter_backwash": {
...
def _rate_complexity(stream_keys: list, inputs: SourceWaterInputs) -> str:
    ...
    complexity_map = {
        ...
        "lime_sludge": 7,           # Very_high — volume is uniquely burdensome, requires lagoons
