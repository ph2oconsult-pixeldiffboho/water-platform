    ...
    Scenario(
        ...
        expected={
            "bnr": {
                ...
                "kwh_kg_nh4": _t(9.0,   Tol.MODERATE, "total plant / NH4 removed"),
                # Sludge
                "sludge":     _t(1478,  Tol.MODERATE, "y_obs≈0.31 incl. inorganic TSS"),
                # Carbon — Scope 2 is deterministic (kWh×grid), check tight
                "scope2_co2": _t(1087,  Tol.TIGHT,    "377 kWh/ML × 10 MLD × 365 × 0.79/1000"),
            ...
            "granular_sludge": {
                ...
                "scope2_co2": _t(1000,  Tol.TIGHT,    "347 kWh/ML × 0.79 grid"),
            ...
            "mabr_bnr": {
                ...
                "kwh_kg_nh4": _t(6.4,   Tol.MODERATE, "MABR best nitrification efficiency"),
                "scope2_co2": _t(924,   Tol.TIGHT,    "320 kWh/ML × 0.79 grid"),
            },
            "ifas_mbbr": {
                ...
                "scope2_co2": _t(1152,  Tol.TIGHT,    "399 kWh/ML × 0.79 grid"),
            },
        },
    ),
    ...
    Scenario(
        ...
        expected={
            "bnr": {
                ...
                "scope2_co2": _t(783,   Tol.TIGHT,    "339 kWh/ML × 8MLD × 365 × 0.79/1000"),
            ...
            "granular_sludge": {
                ...
                "scope2_co2": _t(902,   Tol.TIGHT,    "deterministic"),
            },
            "mabr_bnr": {
                ...
                "scope2_co2": _t(672,   Tol.TIGHT,    "lowest Scope 2 — lowest energy"),
            },
        },
    ),
    ...
    Scenario(
        ...
        expected={
            "bnr": {
                ...
                "kwh_kg_nh4": _t(6.9,   Tol.MODERATE, "BNR nitrification efficiency"),
                "sludge":     _t(1816,  Tol.MODERATE, "12 MLD standard yield"),
                "scope2_co2": _t(1310,  Tol.TIGHT,    "deterministic"),
            ...
            "mabr_bnr": {
                ...
                "kwh_kg_nh4": _t(5.4,   Tol.MODERATE, "best nitrif efficiency"),
                "scope2_co2": _t(1099,  Tol.TIGHT,    "deterministic"),
            ...
            "bnr_mbr": {
                ...
                "scope2_co2": _t(1689,  Tol.TIGHT,    "highest Scope 2 — highest energy"),
    ...
    Scenario(
        ...
        expected={
            "bnr": {
                ...
                "scope2_co2": _t(2072,  Tol.TIGHT,    "deterministic"),
            ...
            "granular_sludge": {
                ...
                "scope2_co2": _t(1868,  Tol.TIGHT,    "deterministic"),
            ...
            "bnr_mbr": {
                ...
                "scope2_co2": _t(2652,  Tol.TIGHT,    "deterministic"),
    ...
    Scenario(
        ...
        expected={
            "bnr": {
                ...
                "scope2_co2": _t(1328,  Tol.TIGHT,    "deterministic"),
                "kwh_kg_nh4": _t(9.2,   Tol.MODERATE, ""),
            },
            "mabr_bnr": {
    ...
    Scenario(
        ...
        expected={
            "bnr": {
                ...
                "scope2_co2": _t(2927,  Tol.TIGHT,    "deterministic"),
            },
            "granular_sludge": {
                ...
                "scope2_co2": _t(2721,  Tol.TIGHT,    "deterministic"),
            },
            "bnr_mbr": {
                ...
                "scope2_co2": _t(3618,  Tol.TIGHT,    "highest energy → highest Scope 2"),
            },
        },
    ),
    ...
    Scenario(
        ...
        expected={
            "bnr_mbr": {
                ...
                "scope2_co2": _t(1364,  Tol.TIGHT,    "deterministic"),
            ...
            "granular_sludge": {
                ...
                "scope2_co2": _t(992,   Tol.TIGHT,    "deterministic"),
            ...
            "bnr": {
                ...
                "scope2_co2": _t(1070,  Tol.TIGHT,    "deterministic"),
